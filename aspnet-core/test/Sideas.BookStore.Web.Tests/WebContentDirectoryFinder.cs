...
namespace Sideas.BookStore
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            while (!DirectoryContains(directoryInfo.FullName, "Sideas.BookStore.sln"))
            {
            ...
            var webFolder = Path.Combine(directoryInfo.FullName, $"src{Path.DirectorySeparatorChar}Sideas.BookStore.Web");
